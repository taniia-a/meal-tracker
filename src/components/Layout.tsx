...
const navigation = [
  ...
  { to: '/diario', label: 'Diário', icon: CalendarDays }, { to: '/compras', label: 'Compras', icon: ShoppingCart }, { to: '/progresso', label: 'Progresso', icon: ChartNoAxesCombined }, { to: '/definicoes', label: 'Definições', icon: Settings },
];
